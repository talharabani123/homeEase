...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, StatusBar, SafeAreaView, Animated } from 'react-native';
...
const SubmissionStatusScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    // Submit application to context and get application ID
    const initializeApplication = async () => {
      const result = await submitApplication();
      if (result.success) {
        setApplicationId(contextData.applicationId);
      }
    };

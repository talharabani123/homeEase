...
const EmployeeDetectionScreen = ({ route, navigation }) => {
  ...
  const handleContinue = async () => {
    // Check if this is selfie capture mode
    if (registrationData.captureMode === 'selfie' && registrationData.returnTo === 'SelfieVerification') {
      ...
      if (cameraRef.current) {
        try {
          ...
          // Save to context
          await setContextSelfie(photo.uri);
          
          const data = {
            ...registrationData,
            ...contextData,
            selfieImage: photo.uri,
            selfieVerified: true,
            currentStep: 5
          };
      ...
      // Normal employee detection flow
      const data = {
        ...registrationData,
        ...contextData,
  ...
  const onFacesDetected = () => {
    // This would be called by face detection in production
    // For now, we use the simulated detection
  };
        ...
        <View style={styles.successContainer}>
          <View style={[styles.successCard, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.profileContainer}>
              {(contextData.selfieUri || registrationData.selfieImage) ? (
                <Image 
                  source={{ uri: contextData.selfieUri || registrationData.selfieImage }} 
              ...
              <Text style={[styles.employeeName, { color: colors.text }]}>
                {contextData.fullName || registrationData.fullName || 'Provider Name'}
              </Text>
            </View>
            ...
            <View style={styles.detailsContainer}>
              <View style={styles.detailRow}>
                ...
                <Text style={[styles.detailValue, { color: colors.text }]}>
                  {contextData.fullName || registrationData.fullName || 'N/A'}
                </Text>
              </View>
              <View style={styles.detailRow}>
                <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>CNIC Number</Text>
                <Text style={[styles.detailValue, { color: colors.text }]}>
                  {contextData.cnicNumber || registrationData.cnicNumber || 'N/A'}
                </Text>
              </View>
              <View style={styles.detailRow}>
                <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>Phone Number</Text>
                <Text style={[styles.detailValue, { color: colors.text }]}>
                  {contextData.phoneNumber || registrationData.phoneNumber || 'N/A'}
                </Text>
              </View>
              <View style={styles.detailRow}>
                <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>Email</Text>
                <Text style={[styles.detailValue, { color: colors.text }]}>
                  {contextData.email || registrationData.email || 'N/A'}
                </Text>
              </View>
              <View style={styles.detailRow}>
                <Text style={[styles.detailLabel, { color: colors.textSecondary }]}>Verification Time</Text>
                <Text style={[styles.detailValue, { color: colors.text }]}>
            ...
            <View style={styles.buttonContainer}>
              ...
              >
                <Text style={styles.startButtonText}>
                  {registrationData.captureMode === 'selfie' ? 'Capture Selfie' : 'Start'}
                </Text>
              </TouchableOpacity>
            </View>
          </>
...
export default EmployeeDetectionScreen;